...
<body>
	...
	<div class="main-title">
		<h2>
		公司认证审核(<?php echo ($_total); ?>)[<a href="<?php echo U('index');?>">全部</a> <a href="<?php echo U('index',array('status'=>1));?>">已认证</a> <a href="<?php echo U('index',array('status'=>1));?>">未认证</a>]
	...
	<div class="cf">
		<div class="fl">
			<button class="btn document_add" url="<?php echo U("Article/setStatus",array("status"=>1));?>" >新 增</button>
            <button class="btn ajax-post" target-form="ids" url="<?php echo U("Article/setStatus",array("status"=>1));?>">认 证</button>
			...
			<div class="sleft">
				<div class="drop-down">
					...
					<ul id="sub-sch-menu" class="nav-list hidden">
						...
						<li><a href="javascript:;" value="2">认证</a></li>
						<li><a href="javascript:;" value="1">未认证</a></li>
						<li><a href="javascript:;" value="4">禁用</a></li>
						<li><a href="javascript:;" value="3">待审核</a></li>
					</ul>
				</div>
				<input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入公司名字">
