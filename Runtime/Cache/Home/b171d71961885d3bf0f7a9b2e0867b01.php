...
<html lang="en">
	...
	<body class="login-layout">
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/Public/Home/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='/Public/Home/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
