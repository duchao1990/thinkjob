...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2015-06-12 12:09:17
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `job_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `job_action_log` (
...
--
-- 转存表中的数据 `job_action_log`
--

INSERT INTO `job_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(1, 1, 1, 2130706433, 'member', 1, 'admin在2015-06-12 08:29登录了后台', 1, 1434068970),
(2, 10, 1, 2130706433, 'Menu', 124, '操作url：/admin.php?s=/Menu/add.html', 1, 1434069703),
(3, 10, 1, 2130706433, 'Menu', 125, '操作url：/admin.php?s=/Menu/add.html', 1, 1434069904),
(4, 10, 1, 2130706433, 'Menu', 68, '操作url：/admin.php?s=/Menu/edit.html', 1, 1434069918),
(5, 10, 1, 2130706433, 'Menu', 68, '操作url：/admin.php?s=/Menu/edit.html', 1, 1434069931),
(6, 10, 1, 2130706433, 'Menu', 125, '操作url：/admin.php?s=/Menu/edit.html', 1, 1434069947),
(7, 11, 1, 2130706433, 'category', 2, '操作url：/admin.php?s=/Category/edit.html', 1, 1434070144),
(8, 11, 1, 2130706433, 'category', 1, '操作url：/admin.php?s=/Category/edit.html', 1, 1434070148),
(9, 11, 1, 2130706433, 'category', 2, '操作url：/admin.php?s=/Category/edit.html', 1, 1434070164),
(10, 11, 1, 2130706433, 'category', 39, '操作url：/admin.php?s=/Category/add.html', 1, 1434070237),
(11, 10, 1, 2130706433, 'Menu', 126, '操作url：/admin.php?s=/Menu/add.html', 1, 1434071867),
(12, 10, 1, 2130706433, 'Menu', 127, '操作url：/admin.php?s=/Menu/add.html', 1, 1434072481),
(13, 10, 1, 2130706433, 'Menu', 128, '操作url：/admin.php?s=/Menu/add.html', 1, 1434074580),
(14, 10, 1, 2130706433, 'Menu', 130, '操作url：/admin.php?s=/Menu/add.html', 1, 1434074903),
(15, 10, 1, 2130706433, 'Menu', 131, '操作url：/admin.php?s=/Menu/add.html', 1, 1434075018),
(16, 10, 1, 2130706433, 'Menu', 132, '操作url：/admin.php?s=/Menu/add.html', 1, 1434093091);
...
INSERT INTO `job_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
--
-- 转存表中的数据 `job_attribute`
--

INSERT INTO `job_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `job_auth_extend`
--

CREATE TABLE IF NOT EXISTS `job_auth_extend` (
...
--
-- 转存表中的数据 `job_auth_extend`
--

INSERT INTO `job_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
CREATE TABLE IF NOT EXISTS `job_auth_group` (
...
--
-- 转存表中的数据 `job_auth_group`
--

INSERT INTO `job_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
(3, 'admin', 1, '发包公司', '发布公司', 1, ''),
(4, 'admin', 1, '收包公司', '收包公司', 1, '');

-- --------------------------------------------------------

--
-- 表的结构 `job_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `job_auth_group_access` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
  `group_id` mediumint(8) unsigned NOT NULL COMMENT '用户组id'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `job_auth_group_access`
--

INSERT INTO `job_auth_group_access` (`uid`, `group_id`) VALUES
(2, 3);
...
CREATE TABLE IF NOT EXISTS `job_auth_rule` (
...
--
-- 转存表中的数据 `job_auth_rule`
--

INSERT INTO `job_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
--
-- 转存表中的数据 `job_category`
--

INSERT INTO `job_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `model_sub`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`, `groups`) VALUES
(1, 'blog', '语言', 0, 0, 10, '', '', '', '', '', '', '', '2,3', '2', '2,1', 0, 0, 1, 0, 0, '1', '', 1379474947, 1434070148, 1, 0, ''),
(2, 'default_blog', '亚洲语言', 1, 1, 10, '', '', '', '', '', '', '', '2,3', '2', '2,1,3', 0, 1, 1, 0, 1, '1', '', 1379475028, 1434070164, 1, 0, ''),
(39, 'Japanese', '日语', 2, 0, 10, '', '', '', '', '', '', '', '2', '2', '2,1,3', 0, 1, 1, 0, 0, '', NULL, 1434070237, 1434070237, 1, 0, '');
...
CREATE TABLE IF NOT EXISTS `job_channel` (
...
INSERT INTO `job_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
...
`cid` int(11) NOT NULL COMMENT '公司id',
  `module` enum('out','ser') NOT NULL DEFAULT 'ser' COMMENT '所属模块',
  `cname` varchar(50) NOT NULL COMMENT '公司名字',
  `pwd` char(32) NOT NULL COMMENT '密码',
  `charger` varchar(10) NOT NULL COMMENT '负责人',
  `chargeID` char(18) NOT NULL COMMENT '负责人身份证号码',
  `cdname` varchar(50) DEFAULT NULL COMMENT '公司全称与营业执照上拼配',
  `caddress` varchar(50) NOT NULL COMMENT '公司地址',
  `email` varchar(25) NOT NULL COMMENT '公司邮箱',
  `mobile` varchar(15) DEFAULT NULL COMMENT '手机',
  `oaddress` varchar(50) DEFAULT NULL COMMENT '办公地址',
  `license` int(11) DEFAULT NULL COMMENT '营业执照照片对应id',
  `logo` int(11) NOT NULL COMMENT 'logo 文件id',
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '认证状态,0-未认证,1-认证成功'
...
INSERT INTO `job_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
--
-- 转存表中的数据 `job_document`
--

INSERT INTO `job_document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
(1, 1, '', 'OneThink1.1开发版发布', 2, 0, '期待已久的OneThink最新版发布', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 8, 0, 0, 0, 1406001413, 1406001413, 1);

-- --------------------------------------------------------

--
-- 表的结构 `job_document_article`
--

CREATE TABLE IF NOT EXISTS `job_document_article` (
...
--
-- 转存表中的数据 `job_document_article`
--

INSERT INTO `job_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
--
-- 表的结构 `job_document_download`
--

CREATE TABLE IF NOT EXISTS `job_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
INSERT INTO `job_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`) VALUES
...
INSERT INTO `job_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`) VALUES
(1, 'admin', 0, '0000-00-00', '', 10, 2, 0, 1434016735, 2130706433, 1434068970, 1),
(2, 'company', 0, '0000-00-00', '', 0, 0, 0, 0, 0, 0, 1);
...
CREATE TABLE IF NOT EXISTS `job_menu` (
`id` int(10) unsigned NOT NULL COMMENT '文档ID',
...
INSERT INTO `job_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`) VALUES
...
(124, '发包公司', 0, 4, 'Outcom/index', 0, '', '分区公司', 0, 1),
(125, '收包公司', 0, 6, 'Recom/index', 0, '', '任务管理', 0, 1),
(126, '设置', 0, 9, 'Set/index', 0, '常用接口设置', '', 0, 1),
(131, '邮箱设置', 126, 2, 'mail/index', 0, '', '邮箱管理', 0, 1),
(130, '设置平台', 126, 0, 'Set/index', 0, '', '设置平台', 0, 1),
(132, '认证审核', 124, 0, 'Outcom/index', 0, '', '认证管理', 0, 1);
...
CREATE TABLE IF NOT EXISTS `job_model` (
...
INSERT INTO `job_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
CREATE TABLE IF NOT EXISTS `job_set` (
`sid` int(11) NOT NULL COMMENT '配置id',
  `setname` varchar(25) NOT NULL COMMENT '配置名字',
  `setvalue` text NOT NULL COMMENT '配置参数json数据可是存入'
...
INSERT INTO `job_set` (`sid`, `setname`, `setvalue`) VALUES
(1, 'mail', '{"emailhost":"smtp.163.com","emailport":"25","emailuser":"blackday1990@163.com","emailname":"\\u8d85\\u7ea7\\u5de5\\u4f5c","emailpwd":"dc1990","toemail":"332144252@qq.com"}'),
(2, 'mail', '{"EMAILHOST":"smtp.163.com","EMAILPORT":"25","EMAILUSER":"blackday1990@163.com","EMAILPWD":"dc1990","TOEMAIL":"384652412@qq.com"}');

-- --------------------------------------------------------

--
-- 表的结构 `job_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `job_ucenter_admin` (
...
--
-- 表的结构 `job_ucenter_app`
--

CREATE TABLE IF NOT EXISTS `job_ucenter_app` (
...
--
-- 表的结构 `job_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `job_ucenter_member` (
...
--
-- 转存表中的数据 `job_ucenter_member`
--

INSERT INTO `job_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
(1, 'admin', '86fc31ec6eb148facce123cce464bfce', '384652412@qq.com', '', 1434016735, 2130706433, 1434068970, 2130706433, 1434016735, 1),
(2, 'company', '86fc31ec6eb148facce123cce464bfce', 'blackday1990@163.com', '', 1434069148, 2130706433, 0, 0, 1434069148, 1);

-- --------------------------------------------------------

--
-- 表的结构 `job_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `job_ucenter_setting` (
...
`uid` int(11) NOT NULL COMMENT '用户id',
  `module` varchar(10) NOT NULL COMMENT '所属模块',
  `username` varchar(25) NOT NULL COMMENT '用户名',
  `email` varchar(25) NOT NULL COMMENT '邮箱',
  `mobile` varchar(15) NOT NULL COMMENT '手机号码',
  `pwd` char(32) NOT NULL COMMENT '密码',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态,1为激活,0为冻结'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户表(公司/学生)';
...
CREATE TABLE IF NOT EXISTS `job_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
...
--
-- Indexes for table `job_auth_extend`
--
ALTER TABLE `job_auth_extend`
 ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`), ADD KEY `uid` (`group_id`), ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `job_auth_group`
--
ALTER TABLE `job_auth_group`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_auth_group_access`
--
ALTER TABLE `job_auth_group_access`
 ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`), ADD KEY `uid` (`uid`), ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `job_auth_rule`
--
ALTER TABLE `job_auth_rule`
...
--
-- Indexes for table `job_channel`
--
ALTER TABLE `job_channel`
...
ALTER TABLE `job_company`
 ADD PRIMARY KEY (`cid`), ADD UNIQUE KEY `email` (`email`), ADD UNIQUE KEY `email_2` (`email`), ADD UNIQUE KEY `cname` (`cname`);
...
--
-- Indexes for table `job_document_article`
--
ALTER TABLE `job_document_article`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_document_download`
--
ALTER TABLE `job_document_download`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `job_hooks`
--
ALTER TABLE `job_hooks`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `job_member`
--
ALTER TABLE `job_member`
 ADD PRIMARY KEY (`uid`), ADD KEY `status` (`status`);

--
-- Indexes for table `job_menu`
--
ALTER TABLE `job_menu`
 ADD PRIMARY KEY (`id`), ADD KEY `pid` (`pid`), ADD KEY `status` (`status`);

--
-- Indexes for table `job_model`
--
ALTER TABLE `job_model`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_picture`
--
ALTER TABLE `job_picture`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_set`
--
ALTER TABLE `job_set`
 ADD PRIMARY KEY (`sid`);

--
-- Indexes for table `job_ucenter_admin`
--
ALTER TABLE `job_ucenter_admin`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_ucenter_app`
--
ALTER TABLE `job_ucenter_app`
 ADD PRIMARY KEY (`id`), ADD KEY `status` (`status`);

--
-- Indexes for table `job_ucenter_member`
--
ALTER TABLE `job_ucenter_member`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `username` (`username`), ADD UNIQUE KEY `email` (`email`), ADD KEY `status` (`status`);

--
-- Indexes for table `job_ucenter_setting`
--
ALTER TABLE `job_ucenter_setting`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `job_url`
--
ALTER TABLE `job_url`
...
ALTER TABLE `job_user`
 ADD PRIMARY KEY (`uid`), ADD UNIQUE KEY `username` (`username`,`email`), ADD KEY `email` (`email`), ADD KEY `username_2` (`username`);

--
-- Indexes for table `job_userdata`
--
ALTER TABLE `job_userdata`
...
--
-- AUTO_INCREMENT for table `job_channel`
--
ALTER TABLE `job_channel`
...
--
ALTER TABLE `job_company`
MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT COMMENT '公司id';
--
...
--
-- AUTO_INCREMENT for table `job_hooks`
--
ALTER TABLE `job_hooks`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `job_member`
--
ALTER TABLE `job_member`
MODIFY `uid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `job_menu`
--
ALTER TABLE `job_menu`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',AUTO_INCREMENT=133;
--
-- AUTO_INCREMENT for table `job_model`
--
ALTER TABLE `job_model`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '模型ID',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `job_picture`
--
ALTER TABLE `job_picture`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增';
--
-- AUTO_INCREMENT for table `job_set`
--
ALTER TABLE `job_set`
MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT COMMENT '配置id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `job_ucenter_admin`
--
ALTER TABLE `job_ucenter_admin`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '管理员ID';
--
-- AUTO_INCREMENT for table `job_ucenter_app`
--
ALTER TABLE `job_ucenter_app`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '应用ID';
--
-- AUTO_INCREMENT for table `job_ucenter_member`
--
ALTER TABLE `job_ucenter_member`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户ID',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `job_ucenter_setting`
--
ALTER TABLE `job_ucenter_setting`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '设置ID';
--
-- AUTO_INCREMENT for table `job_url`
--
ALTER TABLE `job_url`
